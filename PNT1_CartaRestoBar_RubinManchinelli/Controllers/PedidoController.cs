...
namespace PNT1_CartaRestoBar_RubinManchinelli.Controllers
{
    public class PedidoController : Controller
    {
        private readonly PedidoDatabaseContext _context;

        public PedidoController(PedidoDatabaseContext context)
        {
            _context = context;
        }
